...
export function DashboardOverview() {
  ...
  return (
    <div className="space-y-6">
      <div className="rounded-[2rem] bg-slate-950 px-8 py-10 text-white shadow-glow">
        <Badge tone="sky">Operational Command Center</Badge>
        <h2 className="mt-4 max-w-3xl font-display text-5xl leading-tight">
          High-context dispatch planning with scope intelligence built in.
        </h2>
        <p className="mt-4 max-w-3xl text-base text-slate-300">
          The first release focuses on dispatch visibility, scope drafting, review readiness, and
          clear migration paths from sample data to Excel and enterprise services.
        </p>
      </div>
